...
<script src="<c:url value="/resources/js/script.js" />"></script>
  ...
  <body>
  <img alt="my image" src="<c:url value="/resources/images/BingImageOfTheDay_20230508.jpg" />">
   <div class="container">
   ...
   <button class="btn btn-outline-light mt-5" style="background-color: pink">Search</button>
   </div>
   </form>
   </div>
   </div>
